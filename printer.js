...
const PrinterModule = (() => {
  const MM_TO_PX = 8; // نفس مقياس المعاينة: 70mm=560px ، 50mm=400px
  ...
  function getPrintHtml(product, settings, copies = 1) {
    ...
    return `<!doctype html><html lang="ar" dir="rtl"><head><meta charset="utf-8"><title>Print Label</title>
      <style>
        ...
        *{box-sizing:border-box} html,body{margin:0;padding:0;background:white;font-family:Arial,'Cairo',sans-serif;}
